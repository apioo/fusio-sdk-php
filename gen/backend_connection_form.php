...
class Select
{
     ...
     * @Key("options")
     * @Type("array")
     * @Items(@Ref("BackendConnectionForm\Option"))
     */
    protected $options;
    /**
     * @param string $element
...
class Container
{
     ...
     * @Key("element")
     * @Type("array")
     * @Items(@Schema(oneOf={@Ref("BackendConnectionForm\Input"), @Ref("BackendConnectionForm\Select"), @Ref("BackendConnectionForm\Tag"), @Ref("BackendConnectionForm\Textarea")}))
     */
    protected $element;
    /**
...
class Endpoint
{
    /**
     * @Key("GetQuery")
     * @Ref("BackendConnectionForm\GetQuery")
     */
    protected $GetQuery;
    /**
     * @Key("Container")
     * @Ref("BackendConnectionForm\Container")
     */
    protected $Container;
    /**
