...
class Consumer_App_Collection
{
     ...
     * @Key("entry")
     * @Type("array")
     * @Items(@Ref("ConsumerApp\Consumer_App"))
     */
    protected $entry;
    /**
    ...
    /**
     * @param array<Consumer_App> $entry
     */
...
class Endpoint
{
     ...
     * @Ref("ConsumerApp\Consumer_App_Collection")
     */
    protected $Consumer_App_Collection;
    /**
     * @Key("Consumer_App")
     * @Ref("ConsumerApp\Consumer_App")
     */
    protected $Consumer_App;
    /**
     * @Key("Consumer_Message")
     * @Ref("ConsumerApp\Consumer_Message")
     */
    protected $Consumer_Message;
    /**
     * @param Consumer_App_Collection $Consumer_App_Collection
     */
