...
class Endpoint
{
     ...
     * @Key("Authorization")
     * @Title("authorization")
     * @OneOf(@Ref("AuthorizationToken\Authorization_code"), @Ref("AuthorizationToken\Password"), @Ref("AuthorizationToken\Client_credentials"), @Ref("AuthorizationToken\Refresh_token"))
     */
    protected $Authorization;
    /**
     * @Key("Access_token")
     * @Ref("AuthorizationToken\Access_token")
     */
    protected $Access_token;
    /**
