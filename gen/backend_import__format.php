...
class Resource
{
    ...
    public function __construct(string $format, string $baseUrl, string $token, ?Client $httpClient = null, ?SchemaManager $schemaManager = null)
    {
        $this->format = $format;
     ...
     * @return Adapter
     */
    public function post(Import $data): Adapter
    {
        $options = [
            'headers' => [
        ...
        return $this->convertToObject($data, Adapter::class);
    }
...
class Routes_Method
{
    ...
    /**
     * @Key("responses")
     * @Ref("BackendImportFormat\Routes_Method_Responses")
     */
    protected $responses;
    /**
     * @Key("action")
 ...
 * @PatternProperties(pattern="^(GET|POST|PUT|PATCH|DELETE)$", property=@Ref("BackendImportFormat\Routes_Method"))
 */
...
class Routes_Version
{
    ...
    /**
     * @Key("methods")
     * @Ref("BackendImportFormat\Routes_Methods")
     */
    protected $methods;
    /**
     * @param int $version
...
class Connection
{
    ...
    /**
     * @Key("config")
     * @Ref("BackendImportFormat\Connection_Config")
     */
    protected $config;
    /**
     * @param int $id
...
class Schema
{
    ...
    /**
     * @Key("source")
     * @Ref("BackendImportFormat\Schema_Source")
     */
    protected $source;
    /**
     * @param int $id
...
class Action
{
    ...
    /**
     * @Key("config")
     * @Ref("BackendImportFormat\Action_Config")
     */
    protected $config;
    /**
     * @param int $id
...
class Routes
{
     ...
     * @Key("config")
     * @Type("array")
     * @Items(@Ref("BackendImportFormat\Routes_Version"))
     */
    protected $config;
    /**
     * @param int $id
...
class Adapter
{
     ...
     * @Key("routes")
     * @Type("array")
     * @Items(@Ref("BackendImportFormat\Routes"))
     */
    protected $routes;
    /**
     * @Key("action")
     * @Type("array")
     * @Items(@Ref("BackendImportFormat\Action"))
     */
    protected $action;
    /**
     * @Key("schema")
     * @Type("array")
     * @Items(@Ref("BackendImportFormat\Schema"))
     */
    protected $schema;
    /**
     * @Key("connection")
     * @Type("array")
     * @Items(@Ref("BackendImportFormat\Connection"))
     */
...
class Endpoint
{
    /**
     * @Key("Import")
     * @Ref("BackendImportFormat\Import")
     */
    protected $Import;
    /**
     * @Key("Adapter")
     * @Ref("BackendImportFormat\Adapter")
     */
    protected $Adapter;
    /**
     * @param Import $Import
