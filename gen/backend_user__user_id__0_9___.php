...
namespace BackendUserUser_id09;
...
class Resource
{
    ...
    public function __construct(int $user_id, string $baseUrl, string $token, ?Client $httpClient = null, ?SchemaManager $schemaManager = null)
    {
