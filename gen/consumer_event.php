...
class Resource
{
     ...
     */
    public function get(): Consumer_Event_Collection
    {
        $options = [
            'headers' => [
        ...
        return $this->convertToObject($data, Consumer_Event_Collection::class);
    }
 ...
 */
class Consumer_Event_Collection
{
    /**
     * @Key("totalResults")
     * @Type("integer")
