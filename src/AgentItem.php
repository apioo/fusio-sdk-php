...
#[Discriminator('type')]
#[DerivedType(AgentItemBinary::class, 'binary')]
#[DerivedType(AgentItemChoice::class, 'choice')]
#[DerivedType(AgentItemObject::class, 'object')]
#[DerivedType(AgentItemText::class, 'text')]
#[DerivedType(AgentItemToolCall::class, 'tool_call')]
abstract class AgentItem implements \JsonSerializable, \PSX\Record\RecordableInterface
{
