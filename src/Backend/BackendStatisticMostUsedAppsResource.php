<?php 
/**
 * BackendStatisticMostUsedAppsResource generated on 2021-01-27
...
class BackendStatisticMostUsedAppsResource extends ResourceAbstract
{
     ...
     */
    public function backendActionStatisticGetMostUsedApps(?Backend_Log_Collection_Query $query): Statistic_Count
    {
        $options = [
