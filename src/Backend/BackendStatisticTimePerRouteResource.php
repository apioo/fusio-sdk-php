<?php 
/**
 * BackendStatisticTimePerRouteResource generated on 2021-01-27
...
class BackendStatisticTimePerRouteResource extends ResourceAbstract
{
     ...
     */
    public function backendActionStatisticGetTimePerRoute(?Backend_Log_Collection_Query $query): Statistic_Count
    {
        $options = [
