<?php
/**
 * ConsumerAccountChangePasswordResource generated on 2022-05-06
...
class ConsumerAccountChangePasswordResource extends ResourceAbstract
{
     ...
     * @return Message
     */
    public function consumerActionUserChangePassword(?Account_ChangePassword $data = null): Message
    {
        $options = [
            'json' => $data
        ];
