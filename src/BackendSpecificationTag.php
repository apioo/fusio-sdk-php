...
class BackendSpecificationTag extends TagAbstract
{
    /**
     * Returns the TypeHub specification
     *
     * @return BackendSpecificationGet
     * @throws CommonMessageException
     * @throws ClientException
     */
    public function get(): BackendSpecificationGet
    {
        ...
        try {
            ...
            $data = $this->parser->parse((string) $body, \PSX\Schema\SchemaSource::fromClass(BackendSpecificationGet::class));
