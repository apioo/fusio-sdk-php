...
class BackendRoleTag extends TagAbstract
{
    ...
    public function get(string $roleId): BackendRole
    {
        ...
        try {
            ...
            $data = $this->parser->parse((string) $body, \PSX\Schema\SchemaSource::fromClass(BackendRole::class));
    ...
    public function getAll(?int $startIndex = null, ?int $count = null, ?string $search = null): BackendRoleCollection
    {
        ...
        try {
            ...
            $data = $this->parser->parse((string) $body, \PSX\Schema\SchemaSource::fromClass(BackendRoleCollection::class));
